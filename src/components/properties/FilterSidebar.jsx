      ...
      <div className="pt-2">
        <button
          onClick={() => {
            setFilter({
              type: "الكل",
              priceRange: [priceRanges[currency].min, priceRanges[currency].max],
              bedrooms: "أي",
              bathrooms: "أي",
              area: [0, 1000],
              currency: currency
          ...
          className="w-full py-2 px-4 bg-red-600 hover:bg-red-700 text-white font-medium rounded-md transition-colors duration-300 flex items-center justify-center"
        >
