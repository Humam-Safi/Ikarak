          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                تأسست عقارك حمص في عام 2024، وكانت في طليعة صناعة العقارات في
                سوريا. بدأنا بمهمة بسيطة: مساعدة الناس في العثور على منازلهم
                المثالية وجعل عملية شراء العقارات سلسة قدر الإمكان.
              </p>
              <p className="text-gray-600">
                اليوم، نحن فخورون بأن نكون أحد المنصات العقارية الرائدة في
                سوريا، حيث نربط آلاف المشترين والبائعين كل عام.
              </p>
            </div>
            <div >
